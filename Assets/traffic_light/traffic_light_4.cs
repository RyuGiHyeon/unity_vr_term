...
public class traffic_light_4 : MonoBehaviour
{
    public GameObject redObject4;
    public GameObject greenObject4;
    public GameObject yellowObject4;
    ...
    private void Start()
    {
        ...
        redMaterial = redObject4.GetComponent<Renderer>().material;
        greenMaterial = greenObject4.GetComponent<Renderer>().material;
        yellowMaterial = yellowObject4.GetComponent<Renderer>().material;
